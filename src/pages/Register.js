        ...
        <div className="flex flex-col">
          ...
          <div className="mb-5 flex flex-col gap-y-8 w-full justify-center p-10 pt-4">
              <FloatLabel className="flex">
                ...
                />
                <label className='ml-5 font-semibold' htmlFor="username">Kullanıcı Adı</label>
              </FloatLabel>
              <FloatLabel className="flex">
                <InputText
                  className="h-14 border-red-500 rounded-5 border w-full rounded-lg shadow-lg shadow-gray"
                  ...
                  type='password'
                />
                <label className='ml-5 font-semibold' htmlFor="password">Şifre</label>
              </FloatLabel>
              <FloatLabel className="flex">
                <InputText
                  className="h-14 border-red-500 rounded-5 border w-full rounded-lg shadow-lg shadow-gray"
                  ...
                  onChange={(e) => setValue(e.target.value)}
                />
                <label className='ml-5 font-semibold' htmlFor="mail">Mail</label>
              </FloatLabel>
              <FloatLabel className="flex">
                <InputText
                  className="h-14 border-red-500 rounded-5 border w-full rounded-lg shadow-lg shadow-gray"
                  ...
                  onChange={(e) => setValue(e.target.value)}
                />
                <label className='ml-5 font-semibold' htmlFor="phone">Telefon Numarası</label>
              </FloatLabel>
            <Button
